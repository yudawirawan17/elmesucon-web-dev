...
Route::group(['middleware' => ['auth','checkRole:admin']],function(){    
    ...
    Route::get('/admin/transaction')->name('report.transaction')->uses('admin\ProductController@datatablesIndex');
    Route::get('/report/print', 'admin\ProductController@print')->name('print');
});
...
Route::group(['middleware' => ['auth','checkRole:customer']],function(){
    ...
    Route::match(['get', 'post'], 'checkout','User\CheckoutController@index')->name('user.checkout');
});
