          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <h4>Register</h4>
                <h6 class="font-weight-light">Buat akun baru.</h6>
                ...
                @enderror
                  ...
                  <div class="text-center mt-4 font-weight-light"> Sudah punya akun? <a href="login.html" class="text-primary">Login</a>
                  </div>
                </form>
              </div>
            </div>
