        ...
        @csrf
            ...
            <tbody>
                ...
                <td class="product-thumbnail">
                    <img src="{{ asset('storage/'.$keranjang->image) }}" alt="Image" class="img-fluid" width="70">
                </td>
                ...
                <td><a href="{{ route('user.keranjang.delete',['id' => $keranjang->id]) }}" class="btn btn-danger btn-sm">X</a></td>
                </tr>
                <?php endforeach;?>
            </tbody>
            </table>
    ...
    <div class="row">
        ...
        <div class="row mb-5">
            ...
            <div class="form-group">
                @csrf
                <label for="exampleFormControlSelect2">Pilih Kurir</label>
                    <select class="form-control" name="kurir" id="exampleFormControlSelect2">
        ...
        <div class="row justify-content-end">
            ...
            <div class="row">
                @if($cekalamat > 0)
                <div class="col-md-12">
                <button href="{{ route('user.checkout') }}" type="submit" class="btn btn-success btn-lg py-3 btn-block" >Checkout</button>
            </form>
                </div>
                @else
                <div class="col-md-12">
