					     ...
					     <div class="row col-sm-12">
					        <div class="col-sm-6">
					            <div class="form-group col-sm-12">
					                ...
					                <input type="text" name="product_code" class="form-control" placeholder="Masukan kode produk" value="{{ old('product_code') }}">
					            </div>
					        </div>
					        <div class="col-sm-6">
					            <div class="form-group col-sm-12">
					        ...
					        <div class="col-sm-4">
					            <div class="form-group col-sm-12">
					                ...
					                <input type="text" name="stock" class="form-control" placeholder="Masukan stok barang" value="{{ old('stock') }}">
					            </div>
					        </div>
					        <div class="col-sm-4">
					            <div class="form-group col-sm-12">
					        ...
					        <div class="col-sm-12">
					            <div class="form-group col-sm-12">
					                ...
					                <textarea class="form-control" style="height:150px" name="detail" placeholder="Masukan detail deskripsi produk" >{{ old('detail') }}</textarea>
					            </div>
					        </div>
